        ...
        <form action="<?php echo $action; ?>" method="post">              
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" <?php echo $a;?> name="kode" class="form-control" id="kode" placeholder="Kode" value="<?php echo $kode; ?>" >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="telp">Telp <?php echo form_error('telp') ?></label>
