        ...
        <form action="<?php echo $action; ?>" method="post">              
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="harga" class="form-control" id="harga" placeholder="Harga" value="<?php echo $harga; ?>" /> 
            </div>
          </div>
          <!-- /.card-body -->
          ...
          <div class="card-footer">
              ...
              <a href="<?php echo base_url('barang') ?>" class="btn btn-second">Cancel</a>
          </div>
        </form>
      </div>
      <!-- /.card -->
